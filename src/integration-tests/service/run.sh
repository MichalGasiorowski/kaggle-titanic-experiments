...
pipenv run python "${DOCKER_PREDICT_DIR}"/test_predict.py --url 'http://localhost:9000/2015-03-31/functions/function/invocations' --scenario 'single_service'

pipenv run python "${DOCKER_PREDICT_DIR}"/test_predict.py --url 'http://localhost:9000/2015-03-31/functions/function/invocations' --scenario 'multi_service'
